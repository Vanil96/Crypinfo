...
async function Crypto_ind() {
    ...
    crypto_href= "https://min-api.cryptocompare.com/data/pricemultifull?fsyms=BCH&tsyms=USD,PLN,EUR,GBP"+apikey;
...
const price_pln = data.RAW.BCH.PLN.PRICE;
const price_usd = data.RAW.BCH.USD.PRICE;
const price_eur = data.RAW.BCH.EUR.PRICE;
const low = data.RAW.BCH.PLN.LOW24HOUR;
const high = data.RAW.BCH.PLN.HIGH24HOUR;
const change = data.RAW.BCH.PLN.CHANGEPCT24HOUR; 
const kapital = data.RAW.BCH.USD.MKTCAP;   
const wolumen = data.RAW.BCH.USD.VOLUME24HOUR; 
...
async function newsy_ind() {
    let apikey="&api_key=a19ca4952f0fe76f7457c50e3df9029c473e710c3e29360c97d2afb621b25816";
    newsy_href= "https://min-api.cryptocompare.com/data/v2/news/?categories=BCH,BitcoinCash"+apikey;    

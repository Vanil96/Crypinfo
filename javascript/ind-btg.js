...
async function Crypto_ind() {
    ...
    crypto_href= "https://min-api.cryptocompare.com/data/pricemultifull?fsyms=BTG&tsyms=USD,PLN,EUR,GBP"+apikey;
...
const price_pln = data.RAW.BTG.PLN.PRICE;
const price_usd = data.RAW.BTG.USD.PRICE;
const price_eur = data.RAW.BTG.EUR.PRICE;
const low = data.RAW.BTG.PLN.LOW24HOUR;
const high = data.RAW.BTG.PLN.HIGH24HOUR;
const change = data.RAW.BTG.PLN.CHANGEPCT24HOUR; 
const kapital = data.RAW.BTG.USD.MKTCAP;   
const wolumen = data.RAW.BTG.USD.VOLUME24HOUR; 

...
async function Crypto_ind() {
    ...
    crypto_href= "https://min-api.cryptocompare.com/data/pricemultifull?fsyms=DASH&tsyms=USD,PLN,EUR,GBP"+apikey;
...
const price_pln = data.RAW.DASH.PLN.PRICE;
const price_usd = data.RAW.DASH.USD.PRICE;
const price_eur = data.RAW.DASH.EUR.PRICE;
const low = data.RAW.DASH.PLN.LOW24HOUR;
const high = data.RAW.DASH.PLN.HIGH24HOUR;
const change = data.RAW.DASH.PLN.CHANGEPCT24HOUR; 
const kapital = data.RAW.DASH.USD.MKTCAP;   
const wolumen = data.RAW.DASH.USD.VOLUME24HOUR; 
...
async function newsy_ind() {
    let apikey="&api_key=a19ca4952f0fe76f7457c50e3df9029c473e710c3e29360c97d2afb621b25816";
    newsy_href= "https://min-api.cryptocompare.com/data/v2/news/?categories=Dash,DIGITALCASH,Business"+apikey;    

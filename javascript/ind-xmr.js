...
async function Crypto_ind() {
    ...
    crypto_href= "https://min-api.cryptocompare.com/data/pricemultifull?fsyms=XMR&tsyms=USD,PLN,EUR,GBP"+apikey;
...
const price_pln = data.RAW.XMR.PLN.PRICE;
const price_usd = data.RAW.XMR.USD.PRICE;
const price_eur = data.RAW.XMR.EUR.PRICE;
const low = data.RAW.XMR.PLN.LOW24HOUR;
const high = data.RAW.XMR.PLN.HIGH24HOUR;
const change = data.RAW.XMR.PLN.CHANGEPCT24HOUR; 
const kapital = data.RAW.XMR.USD.MKTCAP;   
const wolumen = data.RAW.XMR.USD.VOLUME24HOUR; 
...
async function newsy_ind() {
    let apikey="&api_key=a19ca4952f0fe76f7457c50e3df9029c473e710c3e29360c97d2afb621b25816";
    newsy_href= "https://min-api.cryptocompare.com/data/v2/news/?categories=Xmr,Monero"+apikey;    

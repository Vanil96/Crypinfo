...
async function Crypto_ind() {
    ...
    crypto_href= "https://min-api.cryptocompare.com/data/pricemultifull?fsyms=LSK&tsyms=USD,PLN,EUR,GBP"+apikey;
...
const price_pln = data.RAW.LSK.PLN.PRICE;
const price_usd = data.RAW.LSK.USD.PRICE;
const price_eur = data.RAW.LSK.EUR.PRICE;
const low = data.RAW.LSK.PLN.LOW24HOUR;
const high = data.RAW.LSK.PLN.HIGH24HOUR;
const change = data.RAW.LSK.PLN.CHANGEPCT24HOUR; 
const kapital = data.RAW.LSK.USD.MKTCAP;   
const wolumen = data.RAW.LSK.USD.VOLUME24HOUR; 

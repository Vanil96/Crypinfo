...
const api_cryp = "https:min-api.cryptocompare.com/data/pricemulti?fsyms=BTC,ETH,LSK,BTG,LTC,DASH,XMR,KZC&tsyms=PLN";
...
var usd = fiat[0].rates[1].mid; 
  ...
  // var cad = data1[0].rates[4].mid;
 //  var chf = data1[0].rates[9].mid;
 //  var gbp = data1[0].rates[10].mid;
